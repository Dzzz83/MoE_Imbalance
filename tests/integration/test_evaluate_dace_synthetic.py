...
Real-function regression coverage lives in tests/integration/test_evaluate_dace_real.py.
...
def test_class_groups_from_real_helper():
    ...
    which is 35/35/30 (asserted in tests/regression/test_protocol_splits.py). Do not quote
